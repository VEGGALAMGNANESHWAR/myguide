...
class Customer(models.Model):
    ...
    type_of = models.CharField(max_length = 10 , blank=False,default='SOME STRING')
    def __str__(self) :
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        return f"{self.product.no_of_Rooms} of {self.product.name}"
...
class Order(models.Model):
    ...
    def get_grand_total(self):
        grand_total = 0
        grand_total = self.get_total_price()
        return grand_total
